...
@Component({
  selector: 'app-login',
  standalone: true,
  imports: [InputComponent, ReactiveFormsModule, ControlComponent, KeyValuePipe, ControlErrorPipe],
  template: `
            ...
            >
              ...
              <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
                ...
                <p class="mt-4 text-sm text-gray-500 sm:mt-0">
                  ...
                  <a routerLink="/auth/register" class="text-gray-700 underline"
                    >Register</a
                  >.
                </p>
              </div>
